...
public class OrderRefundActivity extends BackBaseActivity {
    ...
    @BindView(R.id.tv_refunde_about)
    ...
    protected String getTitile() {
        return getResources().getString(R.string.title_order_refund);
    }
    ...
    private void showFailDialog() {
        new AlertDialog(this).builder()
                ...
                .setNegativeButton(getResources().getString(R.string.quit), new View.OnClickListener() {
                    @Override
