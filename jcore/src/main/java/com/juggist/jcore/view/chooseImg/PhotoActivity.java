...
public class PhotoActivity extends BaseActivity {
	...
	protected int getLayoutId() {
		return R.layout.pickimg_activity_photo;
	}
	...
	protected void initSystemStatusBar() {
		...
		immersionBar.statusBarDarkFont(false).statusBarColor(R.color.black).fitsSystemWindows(true).keyboardEnable(true).init();
	}
