...
public class DialogSessionSetting extends DialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.home_dialog_session_setting, container, false);
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        //声明控件
        iv_close = view.findViewById(R.id.home_iv_close);
        lv = view.findViewById(R.id.home_lv);
        btn_ensure = view.findViewById(R.id.home_btn_ensure);
        et = view.findViewById(R.id.home_et);
...
//        lp.height = (int) getResources().getDimension(R.dimen.dp_400);//改变高度
    ...
    private class Adapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                vh = new ViewHolder();
                convertView = LayoutInflater.from(getActivity()).inflate(R.layout.home_adapter_session_setting_item, null);
                vh.iv = convertView.findViewById(R.id.home_iv);
                vh.tv = convertView.findViewById(R.id.home_tv);
