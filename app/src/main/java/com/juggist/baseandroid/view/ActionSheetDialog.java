...
public class ActionSheetDialog {
    ...
    private void setSheetItems() {
        ...
        for (int i = 1; i <= size; i++) {
            ...
            if (size == 1) {
                if (showTitle) {
                    textView.setBackgroundResource(R.drawable.actionsheet_bottom_with_top_line);
                } else {
            ...
            int height = context.getResources().getDimensionPixelSize(R.dimen.dp_114);
