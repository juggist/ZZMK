...
import com.juggist.jcore.view.chooseImg.adapter.ImageBucketAdapter;
import com.juggist.jcore.view.chooseImg.model.ImageBucket;
...
public class ImageBucketActivity extends BackBaseActivity {
	...
	protected int getLayoutId() {
		return R.layout.pickimg_activity_image_bucket;
	}
	...
	public void initData() {
		...
		// for(int i=-0;i<10;i++){
		// Entity entity = new Entity(R.drawable-mdpi.picture, false);
		// dataList.add(entity);
		// }
		dataList = helper.getImagesBucketList(false);	
		bimap= BitmapFactory.decodeResource(
				getResources(),
				R.drawable.pickimg_add_pic);
