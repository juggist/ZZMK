...
public class AddressAddActivity extends BackBaseActivity {
    ...
    @BindView(R2.id.address_et_name)
    EditText etName;
    @BindView(R2.id.address_et_phone)
    EditText etPhone;
    @BindView(R2.id.address_tv_address)
    TextView tvAddress;
    @BindView(R2.id.address_et_address_detail)
    EditText etAddressDetail;
    @BindView(R2.id.address_btn_ensure)
    Button btnEnsure;
    @BindView(R2.id.address_tv_address_content)
    TextView tvAddressContent;
    @BindView(R2.id.address_ibtn_select)
    ...
    protected int getLayoutId() {
        return R.layout.address_activity_address_add;
    }
        ...
        btnEnsure.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(name) || TextUtils.isEmpty(phone) || TextUtils.isEmpty(address) || TextUtils.isEmpty(addressDetail)) {
                    ToastUtil.showLong(getResources().getString(R.string.common_toast_empty));
                    return;
                }
                if (!RegexUtils.isMobileExact(phone)) {
                    ToastUtil.showLong(getResources().getString(R.string.common_toast_phone_un_right));
                    return;
                }
                if (tag == 0) {
    ...
    private void parseBundle() {
        ...
        if (tag == 0) {//新增
            tv_title.setText(getResources().getString(R.string.address_title_address_add));
        } else if (tag == 1) {//修改
            tv_title.setText(getResources().getString(R.string.address_title_address_edit));
        ...
        userService.addAddress(detail, province_id, city_id, area_id, cellphone, consignee, is_default, new ResponseCallback<String>() {
            ...
            public void onSucceed(String s) {
                ...
                new AlertDialog(AddressAddActivity.this).builder()
                        ...
                        .setNegativeButton(getResources().getString(R.string.common_ensure), new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
    ...
    private void showPickerView() {// 弹出选择器
        ...
        pvOptions = new OptionsPickerBuilder(this, new OnOptionsSelectListener() {
            ...
            public void onOptionsSelect(int options1, int options2, int options3, View v) {
                ...
                .setLayoutRes(R.layout.address_pickview_options_custom, new CustomListener() {
                    @Override
