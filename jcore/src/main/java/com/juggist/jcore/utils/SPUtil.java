...
public class SPUtil {
    ...
    public static <T> boolean saveObjectToShare(String key, T t) {
        return saveObjectToShare(MyBaseApplication.getInstance(), PreferenceName, key, t);
    }
    ...
    public static <T> T getObjectFromShare(String key) {
        return getObjectFromShare(MyBaseApplication.getInstance(), PreferenceName, key);
    }
    ...
    public static void clearObjectFromShare(String key) {
        SharedPreferences.Editor editor = MyBaseApplication.getInstance().getSharedPreferences(PreferenceName, Context.MODE_PRIVATE).edit();
        editor.remove(key);
        editor.apply();
    }
    ...
    public static void saveString(String key, String value) {
        SharedPreferences sp = MyBaseApplication.getInstance().getSharedPreferences(PreferenceName,
    ...
    private void saveBundle(String header, Bundle bundleData) {
        SharedPreferences sp = MyBaseApplication.getInstance().getSharedPreferences(PreferenceName, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sp.edit();
