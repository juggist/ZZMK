...
public class DialogForBuy extends DialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        final TextView tv_choose_num =view.findViewById(R.id.tv_choose_num);
        TextView tv_choose_down =view.findViewById(R.id.tv_choose_down);
        ...
        if(mainPics != null && mainPics.size() > 0){
            Glide.with(getActivity()).load(mainPics.get(0)).into(iv);
        }
...
//        lp.height = (int) getResources().getDimension(R.dimen.dp_400);//改变高度
    ...
    private class Adapter extends BaseAdapter{
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            textView.setBackground(getActivity().getResources().getDrawable(R.drawable.gridview_item_red_bg));
