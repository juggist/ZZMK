...
public class AddOrMinusButton extends LinearLayout {
    ...
    void init() {
        View view = LayoutInflater.from(getContext()).inflate(R.layout.buy_view_button_add_or_minus, this);
        iv_add = view.findViewById(R.id.buy_iv_add);
        iv_minus = view.findViewById(R.id.buy_iv_minus);
        tv_num = view.findViewById(R.id.buy_tv_num);
        iv_add.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (currentNum < maxNum) {
                    ...
                    ToastUtil.showLong(getContext().getResources().getString(R.string.buy_toast_out_of_shop_max_num));
                }
            }
        });
