package com.juggist.order.view;
...
public class DialogRefundAll extends DialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.order_dialog_refund_all, container, false);
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        //声明控件
        iv_close = view.findViewById(R.id.order_iv_close);
        lv = view.findViewById(R.id.order_lv);
...
//        lp.height = (int) getResources().getDimension(R.dimen.dp_400);//改变高度
    ...
    private String[] getItems(){
        return getActivity().getResources().getStringArray(R.array.order_refund_all_reason);
    }
    private class Adapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                vh = new ViewHolder();
                convertView = LayoutInflater.from(getActivity()).inflate(R.layout.order_adapter_session_setting_item, null);
                vh.iv = convertView.findViewById(R.id.order_iv);
                vh.tv = convertView.findViewById(R.id.order_tv);
