...
import com.juggist.baseandroid.ui.mine.fragment.DiscountCardFragment;
...
public class DiscountCardActivity extends BackBaseActivity {
    ...
    protected void initData() {
        ...
        titles = getResources().getStringArray(R.array.discount_card);
    ...
    protected String getTitile() {
        return getResources().getString(R.string.title_discount_card);
    }
