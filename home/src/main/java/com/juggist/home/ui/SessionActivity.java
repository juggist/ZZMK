...
import com.juggist.home.present.SessionPresent;
import com.juggist.home.ui.adapter.SessionItemAdapter;
import com.juggist.home.ui.adapter.SessionItemAdapter.Listener;
import com.juggist.home.view.CreateShareView;
import com.juggist.home.view.DialogForBuy;
...
public class SessionActivity extends BackBaseActivity implements CreateShareView.SaveBitmapListener{
    ...
    @BindView(R2.id.home_tv_shopping_num)
    TextView tvShoppingNum;
    @BindView(R2.id.home_shoppingCart)
    ...
    protected int getLayoutId() {
        return R.layout.home_activity_session;
    }
    ...
    protected void initListener() {
        ...
        shoppingCart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                EventBus.getDefault().post(new HomeTabChangeEvent.TabChange(2));
    ...
    private void initAdapter() {
        adapter = new SessionItemAdapter(R.layout.home_adapter_session_item, new ArrayList<ProductBean.DataBean.GoodsListBean>(), this, new AdapterListener());
    ...
    private class ViewModel extends SmartRefreshViewModel<ProductBean.DataBean.GoodsListBean> implements SessionContract.View {
        ...
        public void addShopCarSucceed(String msg) {
            ToastUtil.showLong(getResources().getString(R.string.home_toast_add_shopcar_succeed));
        }
